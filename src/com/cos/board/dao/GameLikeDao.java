...
public class GameLikeDao {
	...
	private static GameLikeDao instance = new GameLikeDao();
	
	public static GameLikeDao getInstance() {
		return instance;
	}
	
	public int save(int userId, int gid) {
		// 1. Stream 연결
		Connection conn = DBUtil.getConnection();
		PreparedStatement pstmt = null;
		try {
			// 2. 쿼리 전송 클래스 (규약에 맞게)
			final String SQL = "INSERT INTO likegame (userId, gid, recommendation) VALUES (?,?,1)";
